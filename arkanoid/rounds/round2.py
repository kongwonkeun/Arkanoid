...
class Round2(BaseRound):
    ...
    def _create_bricks(self):
        ...
        # Create a dict structure with the brick index as the key, and powerup class as the value.
    ...
    def _create_remaining_powerups(self):
        ...
        remaining_powerups.extend([ExtraLifePowerUp] * 2)
        remaining_powerups.extend([LaserPowerUp] * 8)
        remaining_powerups.extend([CatchPowerUp] * 2)
        remaining_powerups.extend([ExpandPowerUp] * 2)
        remaining_powerups.extend([SlowBallPowerUp] * 1)
        remaining_powerups.extend([DuplicatePowerUp] * 2)
