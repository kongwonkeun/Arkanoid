...
class BaseRound:
    ...
    def __init__(self, top_offset):
        ...
        Args:
            top_offset: The number of pixels from the top of the screen before the top edge can be displayed.
        """
    ...
    def complete(self):
        ...
        Returns:
            True if the round has been completed.
            False otherwise.
        """
    ...
    def can_release_enemies(self):
        ...
        This is round specific, so concrete round subclasses should implement this method.
        """
        raise NotImplementedError('Subclasses must implement can_release_enemies()')

    def _blit_brick(self, brick, x, y):
        """
        Blits the specified brick onto the game area by using a relative coordinate for the position of the brick.
        This is a convenience method that concrete subclasses can use when setting up bricks.
        It assumes that the game area (area within the edges) is split into a grid where each grid square corresponds to one brick.
        The top left most brick is considered position (0, 0). 
        This allows clients to avoid having to work with actual screen positions.
        Note that this method will modify the brick's rect attribute once
        the brick has been set.
        Args:
            brick: The brick instance to position on the grid.
    ...
    def _create_background(self):
        ...
        This method provides a default implementation that simply creates a solid colour for the background, 
        delegating to an abstract hook method for the colour itself. 
        Subclasses may ovrerride this if they wish to provide a more elaborate background (e.g. textured) for a round.
        Returns:
    ...
    def _get_background_colour(self):
        ...
        override _create_background() completely to create a more elaborate background.
        Returns:
    ...
    def _create_edges(self):
        """
        Create the edge sprites and position them at the edges of the screen.
        This implementation creates static edges.
        Subclasses may override if they wish to provide some special animation within an edge.
        Returns:
            A named tuple with attributes 'left', 'right', and 'top' that reference the corresponding edge sprites.
        """
    ...
    def _create_bricks(self):
        ...
        Subclasses must override this abstract method to create and position the bricks.
        Returns:
