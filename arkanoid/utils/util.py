...
def load_png(filename):
    """
    Load a png image with the specified filename 
    from the data/graphics directory and return it and its Rect.
    Args:
        filename: The filename of the image, with or without the '.png' extension.
    Returns:
...
def load_png_sequence(filename_prefix):
    """
    Load a sequence of png images with the specified filename from the data/graphics directory.
    ...
    Args:
        filename_prefix: The beginning of the png filename of each file in the sequence.
    Returns:
...
def font(name, size):
    """
    Get the named font at given size. This will load the font if it hasn't previously been loaded.
    Args:
        name: The filename of the font.
...
def h_centre_pos(surface):
    ...
    Args:
        surface: The surface to get the left coordinate for.
    Returns:
...
def save_high_score(value):
    ...
    The high score is saved in a file called .highscore in the current user's home directory.
    Args:
         value: The high score.
    """
...
def load_high_score():
    ...
    Returns:
        The high score or zero if no previous high score 
        (the .highscore file does not exist).
    """
