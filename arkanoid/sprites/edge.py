...
class TopEdge(pygame.sprite.Sprite):
    ...
    def open_door(self, on_open):
        ...
        fixed delay and the on_open callback invoked, before the door is automatically closed.
...
class SideEdge(pygame.sprite.Sprite):
    ...
    def __init__(self, side):
        """
        Initialise a new SideEdge specifying which side - either 'left' or 'right'.
        Args:
            side: The side - either 'left' or 'right'.
        """
